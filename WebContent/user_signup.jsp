...
<div class="middle">
	...
	<tr>
		...
		<td align="left"><input type="text" name="new_username"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left"><input type="text" name="new_email"></td>
	</tr>
	<tr>
		<td align="left"><p>Nick Name:</p></td>
		<td align="left"><input type="text" name="new_nickname"></td>
	</tr>
	<tr>			
		<td align="left"><p>First Name:</p></td>
		<td align="left"><input type="text" name="new_firstname"></td>
	</tr>
	<tr>
		<td align="left"><p>Last Name:</p></td>
		<td align="left"><input type="text" name="new_lastname"></td>
	</tr>
	<tr>		
		<td align="left"><p>Full Address:</p></td>
		<td align="left"><input type="text" name="new_address"></td>
	</tr>
	<tr>
		<td align="left"><p>Birthday:</p></td>
		<td align="left"><input type="text" name="new_birthday"></td>
	</tr>
	<tr>
		<td align="left"><p>Card Number:</p></td>
		<td align="left"><input type="text" name="new_cardnumber"></td>
	</tr>		
		</table>
	<p></p>
