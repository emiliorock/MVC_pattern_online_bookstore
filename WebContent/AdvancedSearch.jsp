...
<%
	session.setAttribute("SearchType", "AdvancedSearch");
...
%>
	...
	<div class="mainContent">
		...
		<tr>
			<td align="left"><input type="hidden" name="price" /></td>
		</tr>
		</table>
		<p></p>
		...
		<td align="left"><input type="submit" value="Basic Search" class="button"></td>
		</form>
